...
## Quarkus-properties-github
The samples_downloader was used and following query for GitHub
```
python download_samples.py -vk --source github --output output --auth XXXXX --max 300 "filename:resources/application.properties size:>400 quarkus"
```

## Quarkus-yaml-github
The samples_downloader was used and following query for GitHub
```
python download_samples.py -vk --source github --output output --auth XXXXX --max 300 "filename:resources/application.yaml size:>400 quarkus"
python download_samples.py -vk --source github --output output --auth XXXXX --max 300 "filename:resources/application.yml size:>400 quarkus"
```
